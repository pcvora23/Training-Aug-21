...
var newarray = employees.filter(function (val, index, array) {
    return val.ID == 3;
});
...
var joinedarray = employees.concat(emp2);
console.log(joinedarray);
for (var _i = 0, joinedarray_1 = joinedarray; _i < joinedarray_1.length; _i++) {
    var employee = joinedarray_1[_i];
    var pf = 0;
    console.log("-----Employee Deatils-----");
    console.log("Employee Full Name: " + employee.FirstName + " " + employee.LastName);
    var arr = employee.Address.split(",");
    console.log("Flat Number: " + arr[0]);
    console.log("Apartment: " + arr[1]);
    console.log("City: " + arr[2]);
    console.log("State: " + arr[3]);
    console.log("Salary: " + employee.Salary);
    console.log("Professional Tax: " + (employee.Salary) * (12 / 100));
    console.log("--------------------------");
}
